...
import { fetchClientDetails, updateClientDetails } from '../../redux/reducer/billing/ViewClientDetails';
...
function ViewClientDetailsId() {
    ...
    const handleInputChange = (e) => {
        ...
        // Directly update the local state as a temp store until submit
    ...
    const handleUpdateClient = async () => {
        try {
            ...
            navigate("/billing/vieweClient"); // Make sure the path is correct
        } catch (error) {
